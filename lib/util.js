...
Util.extend = function( klass, object ) {
  Util.collection.each( object, function( key, value ) {
...
Util.dom = {
  ...
  to_select: function( items, attributes ) {
    return '<select ' + this.to_attributes( attributes ) + ' >' + 
